...
<section class="banner">
    ...
    <img src="${pageContext.request.contextPath}/img/home/Banner_homepage.jpg">
</section>
...
<footer class="footer">
    <div class="section-container footer-container">
        <div class="footer-col">
            <h3>FHUB COMMUNITY</h3>
            <p>Fhub Community là nền tảng đặt lịch học với gia sư một cách thuận tiện và dễ dàng.</p>
        </div>
        <div class="footer-col">
            <h4>Công ty</h4>
            <p>Về chúng tôi</p>
